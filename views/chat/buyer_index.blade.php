...
@section('main-content')
    <div class="col-12 text-right mb-4">
        ...
        <a class="btn bg-primary-color ml-1" href="javascript:;" onclick="modal_detail('{{ route('chat.buyer.create') }}', 'New Chat Buyer')">New Chat Buyer <i class="fa fa-fw fa-plus"></i></a>
    </div>
    {{--  table  --}}
    <div class="col-12">
        <div class="card m-b-30">
            {{--  <span class="card-header bg-primary-color font-weight-bold adminmt-0"><i class="fa fa-fw fa-table"></i> Data Admin</span>  --}}
            <span class="card-header d-block bg-primary-color font-weight-bold mt-0"><i class="fa fa-fw fa-table"></i> Chat Buyer</span>
