...
@endsection
@section('title')
    <span class="card-header d-block bg-primary-color font-weight-bold buyermt-0"><i class="fa fa-fw fa-edit"></i> Update Buyer</span>
@endsection
...
<form class="form-horizontal mt-2" action="{{ route('buyer.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    ...
    @if ($data->avatar)
        <div class="col-12 text-center">
            <img src="{{ asset('upload/buyer/avatar/' . $data->avatar) }}" alt="" class="img-thumbnail my-2">
        </div>
    @endif
    <div class="row">
        <div class="col-12">
