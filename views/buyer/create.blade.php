...
@section('redirect-back')
    <a href="{{ route('buyer.index') }}" class="btn btn-secondary mb-3"><i class="fa fa-fw fa-arrow-left mr-1"></i>Back</a>
@endsection
@section('title')
    <span class="card-header d-block bg-primary-color font-weight-bold buyermt-0"><i class="fa fa-fw fa-edit"></i> Add Buyer</span>
@endsection
@section('main-content')
    <form class="form-horizontal mt-2" action="{{ route('buyer.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12 text-right">
                ...
                <button class="btn bg-primary-color buyerwaves-effect waves-light" type="submit">Add Buyer</button>
            </div>
        </div>
    </form>
@endsection
