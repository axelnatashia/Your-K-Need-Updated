                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                @if (returnIsLogin())
                                    ...
                                    @if(returnAuthAvatar(returnDataLogin()))
                                        ...
                                        @endphp
                                        <img src="{{ url($url)}}" alt="user" class="rounded-circle" width="40">
                                    @else
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                @if (isset($login))
                                    <a class="dropdown-item" href="{{ '/'. $login .'/profile' }}"><i class="fas fa-fw fa-user mr-2 ml-1"></i>
                                        My Profile</a>
                                    <a class="dropdown-item" href="{{ route('landing.wishlist') }}"><i class="fas fa-fw fa-heart mr-2 ml-1"></i>
                                        Wishlist</a>
                                    <a class="dropdown-item" href="{{ route('landing.cart') }}"><i class="fas fa-fw fa-cart-plus mr-2 ml-1"></i>
                                        Cart</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('landing.paylater') }}"><i class="fas fa-fw fa-money-check mr-2 ml-1"></i>
                                        Pay Later</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('logout') }}"><i  class="fas fa-fw fa-sign-out-alt mr-2 ml-1"></i>
                                        Logout</a>
                                @else
                                    <a class="dropdown-item" href="{{ route('form_login') }}"><i class="fas fa-fw fa-sign-in-alt mr-2 ml-1"></i>
                                        Login</a>
                                @endif
